function [eps] = elementstrains(meshdata,input,el_type,el_props,d)
% EPS = ELEMENTSTRAINS(meshdata,input,el_type,el_props,d)
% Computes nodal strains for a structure of bar elements (el_type = 1)
% or beam elements (el_type = 2)
