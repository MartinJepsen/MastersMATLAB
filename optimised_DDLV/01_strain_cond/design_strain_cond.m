...
%%
save(sprintf("optimised_DDLV/01_strain_cond/unit_perturbations/gains_%d",damel),"gains")

function [J] = main_gain_design(X)

    load("simulation/system_matrices/unit_perturbation/model_5")          % load system matrices
    n_dof = size(Kg,1);
